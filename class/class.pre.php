...
class recetas
{
    ...
    public function get_list()
    {
        ...
        while ($row = $res->fetch_assoc()) {
            ...
            <tr>
                ...
                <td>' . $row['Cantidad'] . '</td>
                <td class="text-center"><button class="btn btn-info"><a href="pre.php?d=' . $d_det_final . '">Detalle</a></button></td>
            </tr>';
        }
        $html .= '</table>';
        return $html;
                    ...
                    <div class="card-header" style="background-color: #FFA500; color: white;">
                        ...
                        <div class="card-body">
                            <table class="table">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <a href="pre.php" class="btn btn-primary">Regresar</a>
                                    </td>
                                </tr>
                            </table>
                        </div>
    ...
    private function _message_error($tipo)
    {
		...
		<table border="0" align="center">
			...
			<tr>
				<th><a href="pre.php">Regresar</a></th>
			</tr>
		</table>';
        return $html;
    }
