...
class consultas
{
    ...
    public function get_form($id = NULL)
    {
        ...
        $html = '
        <form name="Form_Consulta" method="POST" action="conm.php" enctype="multipart/form-data">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                    <a href="conm.php" class="btn btn-primary">Regresar</a>
    ...
    public function get_list()
    {
        ...
        <form action="../login/recursos/panel1.php" method="get">
        ...
        <table class="table table-bordered text-center table-striped" align="center">
                ...
                <thead>
                    <tr class= "active">
                        <th colspan="9" >Lista de Consultas</th>
                    </tr>
                    <tr>
                        <th colspan="9" class="text-center" style="background-color: #5BAC87;"><a href="conm.php?d=' . $d_new_final . '">Nuevo</a></th>
                    </tr>
                    <tr>
                        <th>Medico</th>
                        <th>Paciente</th>                       
        ...
        $res = $this->con->query($sql);
        // Sin codificar <td><a href="conm.php?op=del&id=' . $row['id'] . '">Borrar</a></td>
        while ($row = $res->fetch_assoc()) {
            ...
            // Agregar la lógica para determinar si el botón debe estar deshabilitado
            $deshabilitarBorrar = true;  // Cambia esto según tu lógica
            ...
            <tr>
                ...
                <td class="text-center"><a href="conm.php?d=' . $d_act_final . '" class="btn btn-warning">Actualizar</a></td>
                <td class="text-center"><a href="conm.php?d=' . $d_det_final . '" class="btn btn-info">Detalle</a></td>
            </tr>';
        }
        $html .= '</table>';
        return $html;
    ...
    private function _message_error($tipo)
    {
		...
		<table border="0" align="center">
			...
			<tr>
				<th><a href="conm.php">Regresar</a></th>
			</tr>
		</table>';
        return $html;
    }
